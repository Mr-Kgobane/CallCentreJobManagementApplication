  ...
  return (
    <div className="client-page">
      <div className="client-page1">
        <div className="client-page-child" />
        <div className="client-page-item" />
        ...
        <div className="client-page-child8" />
        <div className="client-page-child9" />
        <div className="client-page-child10" />
        <div className="client-page-child11" />
        <div className="client-page-child12" />
        <div className="client-page-child13" />
        ...
        <img
          ...
          alt=""
          src="/-icon--call-received--1-1@2x.png"
        />
        <img
      ...
      <div className="outgoing-call">Outgoing Call</div>
      <div className="plumbing-req">Plumbing req</div>
      <div className="computer-req">Computer req</div>
      <div className="analyst-req">Analyst req</div>
      <div className="mechanic-req">Mechanic req</div>
      <div className="it-technician-req">IT technician req</div>
      <div className="electrician-req">Electrician req</div>
      <div className="outgoing-call1">Outgoing Call</div>
      <div className="outgoing-call2">Outgoing Call</div>
